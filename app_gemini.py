...
if not st.session_state.setup_complete:
    ...
    with col2:
        st.session_state["position"] = st.selectbox(
            "Choose a position",
            ("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst", "Financial Analyst", "Web Developer", "Python Developer", "HR" ,"Cloud Engineer", "QA Engineer", "MobileApp Developer"),
            index=("Data Scientist", "Data Engineer", "ML Engineer", "BI Analyst", "Financial Analyst", "Web Developer", "Python Developer", "HR" ,"Cloud Engineer", "QA Engineer", "MobileApp Developer").index(st.session_state["position"])
        )

    st.session_state["company"] = st.selectbox(
        "Select a Company",
        ("Amazon", "Meta", "Udemy", "365 Company", "Nestle", "LinkedIn", "Spotify", "Google"),
        index=("Amazon", "Meta", "Udemy", "365 Company", "Nestle", "LinkedIn", "Spotify", "Google").index(st.session_state["company"])
    )
